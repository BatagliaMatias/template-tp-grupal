...
import ar.fiuba.tdd.tp.engine.motor.commands.LookAround;
import ar.fiuba.tdd.tp.engine.motor.commands.Open;
import ar.fiuba.tdd.tp.engine.motor.commands.Pick;
import ar.fiuba.tdd.tp.engine.motor.commands.Talk;
import ar.fiuba.tdd.tp.engine.motor.commands.proxycommands.ProxyCommand;
import ar.fiuba.tdd.tp.engine.motor.entities.Key;
import ar.fiuba.tdd.tp.engine.motor.entities.LockedDoor;
